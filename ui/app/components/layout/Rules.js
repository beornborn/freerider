        ...
        <Dialog
          ...
          <div>
            ...
            <ol>
              ...
              <li>
                Каждый раунд игры - это поездка. Вы решаете покупать билет или быть хитрожопым и проехать зайцем в надежде, что кто-то другой купит.
              </li>
              <li> Если хитрожопыми окажутся все, и автобусная компания обанкротится. Все останутся без автобусов вообще, то есть все проиграют.
              </li>
